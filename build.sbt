...
libraryDependencies ++= Seq(
  ...
  excludes(("org.apache.spark" %% "spark-streaming" % "3.2.0").cross(CrossVersion.for3Use2_13)),
  excludes(("org.apache.spark" %% "spark-streaming-kafka-0-10" % "3.2.0").cross(CrossVersion.for3Use2_13)),

  excludes("io.github.vincenzobaz" %% "spark-scala3" % "0.1.3"),
  "org.scalameta" %% "munit" % "0.7.26" % Test
)

libraryDependencies += "com.github.losizm" %% "grapple" % "15.0.0"
